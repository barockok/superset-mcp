...
function parseArgs(args: string[]): { baseUrl: string; cookie: string } {
  ...
  if (!baseUrl) throw new Error("Missing required argument: --base-url");
  if (!cookie) throw new Error("Missing required argument: --cookie");
