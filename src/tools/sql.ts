...
export function registerSqlTools(server: McpServer, client: SupersetClient) {
  server.tool(
    "run_sql_query",
    "Execute a SQL query against a Superset database connection. Returns the query results.",
    {
  ...
  server.tool(
    "get_saved_query",
    "Get a saved SQL query by ID, including the SQL text.",
    { id: z.number().describe("Saved query ID") },
